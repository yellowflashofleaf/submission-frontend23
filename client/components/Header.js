import { Button, Flex, Image, Menu, MenuButton, MenuItem, MenuList, useColorMode, useColorModeValue } from '@chakra-ui/react'
...
const Header = () => {
  ...
  return (
    ...
    >
      <Link href='/'>
        {colorMode === 'light' ? (<Image src='/logo-dark.png' h={8} alt={"logo"} />) : (<Image src="/logo-light.png" h={8} alt={"logo"} />)}
      </Link>
      <Flex
        alignItems={"center"}
        gap={"15px"}
